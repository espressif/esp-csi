...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.groupBox_raw_data)
        self.verticalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_8.setSpacing(0)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.splitter_4 = QtWidgets.QSplitter(self.groupBox_raw_data)
        ...
        self.horizontalLayout_8.addWidget(self.checkBox_wave_filtering)
        ...
        self.groupBox_16 = QtWidgets.QGroupBox(self.splitter_4)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.verticalLayout_8.setStretch(0, 128)
        ...
        self.timeEdit_train_duration.setTime(QtCore.QTime(0, 0, 30))
        ...
        self.doubleSpinBox_predict_sameone_threshold = QtWidgets.QDoubleSpinBox(self.widget_31)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.doubleSpinBox_predict_sameone_threshold.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_predict_sameone_threshold.setSizePolicy(sizePolicy)
        self.doubleSpinBox_predict_sameone_threshold.setDecimals(5)
        self.doubleSpinBox_predict_sameone_threshold.setSingleStep(0.001)
        self.doubleSpinBox_predict_sameone_threshold.setProperty("value", 0.001)
        self.doubleSpinBox_predict_sameone_threshold.setObjectName("doubleSpinBox_predict_sameone_threshold")
        self.horizontalLayout_45.addWidget(self.doubleSpinBox_predict_sameone_threshold)
        ...
        self.doubleSpinBox_predict_move_threshold = QtWidgets.QDoubleSpinBox(self.widget_31)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.doubleSpinBox_predict_move_threshold.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_predict_move_threshold.setSizePolicy(sizePolicy)
        self.doubleSpinBox_predict_move_threshold.setDecimals(5)
        self.doubleSpinBox_predict_move_threshold.setSingleStep(0.001)
        self.doubleSpinBox_predict_move_threshold.setProperty("value", 0.001)
        self.doubleSpinBox_predict_move_threshold.setObjectName("doubleSpinBox_predict_move_threshold")
        self.horizontalLayout_45.addWidget(self.doubleSpinBox_predict_move_threshold)
        ...
        self.spinBox_spinBox_predict_outliers_number = QtWidgets.QSpinBox(self.widget_31)
        self.spinBox_spinBox_predict_outliers_number.setMinimum(1)
        self.spinBox_spinBox_predict_outliers_number.setMaximum(99)
        self.spinBox_spinBox_predict_outliers_number.setSingleStep(1)
        self.spinBox_spinBox_predict_outliers_number.setProperty("value", 2)
        self.spinBox_spinBox_predict_outliers_number.setDisplayIntegerBase(10)
        self.spinBox_spinBox_predict_outliers_number.setObjectName("spinBox_spinBox_predict_outliers_number")
        self.horizontalLayout_45.addWidget(self.spinBox_spinBox_predict_outliers_number)
        ...
        self.horizontalLayout_41.setStretch(3, 3)
        self.horizontalLayout_41.setStretch(4, 1)
        self.horizontalLayout_41.setStretch(5, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_number_3.setText(_translate("MainWindow", "wander(sameone) threshold"))
        self.label_number_5.setText(_translate("MainWindow", "jitter(move) threshold"))
        ...
        self.pushButton_evaluate_csi_start.setText(_translate("MainWindow", "csi start"))
